...
export default function AboutShelter() {
    ...
    return (
        <section className="p-8 text-white w-full grid place-items-center flex flex-col gap-6">
            ...
            <p className="text-white/80 text-2xl text-center">San Pedro Animal Shelter is a private and non-profit non-Government Animal Rescue Shelter located in San Pedro Laguna, founded by Wilma Evangelista and other volunteers.
            </p>
